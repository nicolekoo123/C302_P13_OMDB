...
public class Movie {
    ...
    public Movie(String movieId, int year, String title, String rating, String released, String runtime, String genre, String director, String writer, String actors, String plot, String language, String poster) {
